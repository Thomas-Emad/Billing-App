                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="email" class="form-control" id="email"
                                    placeholder="ادخل البريد الالكتروني.." value="{{ old('email', $user->email) }}"
                                    autocomplete="no" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-6">
                                ...
                                <input type="password" name="password" class="form-control" id="password"
                                    placeholder="ادخل كلمة المرور.." autocomplete="no">
                            </div>
                            <div class="col-6">
                                <label for="confirm-password">تاكيد كلمة المرور</label>
                                <input type="password" name="confirm-password" class="form-control" id="confirm-password"
                                    placeholder="ادخل تاكيد كلمة المرور.." autocomplete="no">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-12">
                                ...
                                <select class="form-control select2" id="roles" name="roles[]" multiple="multiple">
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{ $role->id }}" @selected(in_array($role->id, $userRole))>{{ $role->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
