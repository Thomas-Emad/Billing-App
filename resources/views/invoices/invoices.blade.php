                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            @endcan
                            @can('invoices_excel')
                                <a href="{{ url('exportExcelInvoices') }}" class='btn btn-outline-primary btn-inline'>
                                    تصدير الفاتورة كExcel</a>
                            @endcan
                        </div>
                    </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu tx-13">
                                                        <a class="dropdown-item"
                                                            href="{{ route('invoices.show', $invoice->id) }}">طباعة
                                                            الفاتورة</a>
                                                        <a class="dropdown-item"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="{{ route('invoices.destroy', 'Error') }}" method="POST"
                ...
                <div class="modal-header">
                    <h6 class="modal-title">نقل الي الارشيف</h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="id" class="hidden_input">
                    <input type="hidden" name="page" value="1">
                    <h6>هل تريد نقل الفاتورة الي الارشيف؟</h6>
                </div>
