                        ...
                        <div class="row mb-2">
                            <div class="col-4">
                                ...
                                <input type="text" name="invoice_number" class="form-control" id="invoice_number"
                                    placeholder="ادخل رقم الفاتورة.." value="{{ old('invoice_number') }}" autocomplete="no"
                                    required>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="row">
                                    <div class="input-group col-12">
                                        <div class="input-group-prepend">
                                            ...
                                            required value="{{ old('date_invoice') }}" autocomplete="no">
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="row">
                                    <div class="input-group col-12">
                                        ...
                                        </div><input name="pay_invoice" id='pay_invoice' class="form-control fc-datepicker"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="value_get" class="form-control value_get" id="value_get"
                                    placeholder="مبلغ المحصل عليه.." required value="{{ old('value_get') }}"
                                    autocomplete="no">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control value_work" id="value_work" name="value_work"
                                    placeholder="قيمة العمولة الخاص بك.." required value="{{ old('value_work') }}"
                                    autocomplete="no">
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row mb-2">
                            <div class="col-6">
                                ...
                                <input name="value_get_vat" type="number" class="form-control value_get_vat"
                                    id="value_get_vat" placeholder="قيمة ضريبة القيمة المضافة" readonly required>
                            </div>
                            <div class="col-6">
                                <label for="total">الاجمالي شامل الضريبة</label>
                                <input name="total" type="number" class="form-control total" id="total"
                                    placeholder="الاجمالي شامل الضريبة" required readonly>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <textarea name="note" class="form-control" placeholder="هل لديك ملاحظات خاصا؟.." id="note" rows="3"
                                    value="{{ old('note') }}" autocomplete="no"></textarea>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-12">
                                <label for="attch">المرفقات</label>
                                <p style='font-size:.8rem; color:red;'>*الملفات المسموح .png, .jpg, .pdf فقط.</p>
                                <input type="file" class="dropify" data-height="200" id="attch" name="attch"
                                    accept=".pdf, .png, .jpg, image/jpeg, image/png" />
                            </div>
                        </div>
                        <button type="submit" style="margin:auto;display: block;"
                            class="btn btn-success btn-block mt-4">حفظ
                            الفاتورة</button>
                    </form>
                </div>
            </div>
